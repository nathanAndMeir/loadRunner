...
void Controller::startGame()
{
    for (auto line = std::string();std::getline(m_fileName, line);m_stageNumber++) {
        ...
        m_board.setBoard(m_fileName, m_stageSize);
        m_window.setSize(m_board.getSize());
        if (!play()) {
...
//    playTexture.loadFromFile("/Users/meirbenin/Desktop/test/test/play.png");
//    exitTexture.loadFromFile("/Users/meirbenin/Desktop/test/test/exit.png");
